		...
		<form id="form-user-register">
			<div class="form-row mt-5 mb-4">
				<div class="col-4">
					...
					<div id="feedbackNom" class="feedback">
				...
				<div class="col-4">
					...
					<div id="feedbackCognom" class="feedback">
				...
				<div class="col-4">
					...
					<div id="feedbackDNI" class="feedback">
			...
			<div class="form-row mb-4">
				<div class="col-4">
					...
					<div class="input-group">
						...
						<div id="feedbackUsername" class="feedback">
				...
				<div class="col-4">
					...
					<div id="feedbackEmail" class="feedback">
				...
				<div class="col-4">
					...
					<div id="feedbackTelf" class="feedback">
